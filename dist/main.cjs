// Generated by bd2js (NullSafetyMode.sound, csp, deferred-serialization, intern-composite-values), the BD to JavaScript compiler version: 3.2.0-92.0.dev.
// The code supports the following hooks:
// bdPrint(message):
//    if this function is defined it is called instead of the BD [print]
//    method.
//
// bdMainRunner(main, args):
//    if this function is defined, the BD [main] method will not be invoked
//    directly. Instead, a closure that will invoke [main], and its arguments
//    [args] is passed to [bdMainRunner].
//
// bdDeferredLibraryLoader(uri, successCallback, errorCallback, loadId, loadPriority):
...
//
// bdCallInstrumentation(id, qualifiedName):
...
(function bdProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    toStringWrapper() {
      return J.toString$0$(this.bdException);
    },
    throwExpression(ex) {
    ...
    unwrapException(ex) {
      ...
      if (typeof ex !== "object")
        return ex;
      if ("bdException" in ex)
        return A.saveStackTrace(ex, ex.bdException);
      return A._unwrapNonBDException(ex);
    },
    ...
    convertBDClosureToJS(closure, arity) {
      var $function = closure.$identity;
      if (!!$function)
        return $function;
      $function = A.convertBDClosureToJSUncached(closure, arity);
      closure.$identity = $function;
      return $function;
    },
    convertBDClosureToJSUncached(closure, arity) {
      var entry;
      switch (arity) {
        case 0:
    ...
    initHooks() {
      ...
      if (typeof bdNativeDispatchHooksTransformer != "undefined") {
        transformers = bdNativeDispatchHooksTransformer;
    ...
    getRuntimeTypeOfBDObject(object) {
    ...
    _AsyncRun__initializeScheduleImmediate() {
      ...
      if (self.MutationObserver != null && self.document != null) {
        ...
        new self.MutationObserver(A.convertBDClosureToJS(new A._AsyncRun__initializeScheduleImmediate_internalCallback(t1), 1)).observe(div, {childList: true});
    ...
    _AsyncRun__scheduleImmediateJsOverride(callback) {
      self.scheduleImmediate(A.convertBDClosureToJS(new A._AsyncRun__scheduleImmediateJsOverride_internalCallback(type$.void_Function._as(callback)), 0));
    },
    _AsyncRun__scheduleImmediateWithSetImmediate(callback) {
      self.setImmediate(A.convertBDClosureToJS(new A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback(type$.void_Function._as(callback)), 0));
    },
    ...
    promiseToFuture(jsPromise, $T) {
      ...
      jsPromise.then(A.convertBDClosureToJS(new A.promiseToFuture_closure(completer, $T), 1), A.convertBDClosureToJS(new A.promiseToFuture_closure0(completer), 1));
      return t1;
    },
      ...
      var $async$main = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 8:
              // join
              t2._as(t1.core).info("Installing the " + A.S(os) + "-" + A.S(architecture) + " BD SDK version " + A.S(version) + " from the " + A.S(channel) + " (" + A.S(flavor) + ") channel.");
              url = string$.https_ + A.S(channel) + "/" + A.S(flavor) + "/" + A.S(version) + "/sdk/bdsdk-" + A.S(os) + "-" + A.S(architecture) + "-release.zip";
              toolName = A.boolConversionCheck(raw) ? "bd_raw" : "bd";
            ...
            case 25:
              ...
              extractedFolder = A.join(extractedFolder, "bd-sdk");
              $async$goto = 26;
            ...
            case 22:
              ...
              t2._as(t1.core).exportVariable("BD_HOME", sdkPath);
            ...
            case 27:
              ...
              if (A.boolConversionCheck(raw)) {
                ...
                t3.setOutput("bd-version", B.JSString_methods.trim$0(A._asString(t2._as(t1.fs).readFileSync(versionFilePath, "utf8"))));
              } else
                t2._as(t1.core).setOutput("bd-version", version);
              $async$goto = 28;
              return A._asyncAwait(A.promiseToFuture(t2._as(t2._as(t1.exec).exec("bd", A._setArrayType(["--version"], type$.JSArray_String))), type$.dynamic), $async$main);
            case 28:
              // returning from await.
              $async$handler = 2;
              // goto after finally
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$goto = 4;
              return A._asyncAwait(A.promiseToFuture(t2._as(t2._as(t1.exec).exec("bd", A._setArrayType(["pub", "token", "add", "https://pub.dev", "--env-var", "PUB_TOKEN"], type$.JSArray_String))), type$.dynamic), $async$createPubOIDCToken);
            case 4:
              // returning from await.
            case 1:
              // return
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = t1;
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(t1._as(t1._as(new self.HttpClient("setup-bd", A._setArrayType([], type$.JSArray_Object), type$.nullable_JSObject._as(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["allowRedirects", true, "maxRedirects", 3, "allowRetries", true, "maxRetries", 3], type$.String, type$.Object))))).getJson(string$.https_ + channel + "/" + flavor + "/latest/VERSION")), t1), $async$latestPublishedVersion);
            case 3:
              // returning from await.
  ...
  J = {
    ...
    getNativeInterceptor(object) {
      ...
      if ($constructor == null)
        ...
        if (t1 == null)
          t1 = $._JS_INTEROP_INTERCEPTOR_TAG = init.getIsolateTag("_$bd_js");
  ...
  J.JavaScriptFunction.prototype = {
    toString$0(receiver) {
      var bdClosure = receiver[$.$get$BD_CLOSURE_PROPERTY_NAME()];
      if (bdClosure == null)
        return this.super$LegacyJavaScriptObject$toString(receiver);
      return "JavaScript function for " + J.toString$0$(bdClosure);
    },
    $isFunction: 1
  };
  ...
  A._TimerImpl.prototype = {
    _TimerImpl$2(milliseconds, callback) {
      if (self.setTimeout != null)
        self.setTimeout(A.convertBDClosureToJS(new A._TimerImpl_internalCallback(this, callback), 0), milliseconds);
      else
  ...
  A.Object.prototype = {$isObject: 1,
    ...
    get$runtimeType(_) {
      return A.getRuntimeTypeOfBDObject(this);
    },
    toString() {
  ...
  var string$ = {
    ...
    https_: "https://storage.googleapis.com/bd-archive/channels/"
  };
  ...
  if (typeof bdExperimentalFixupGetTag != "function") return hooks;
  hooks.getTag = bdExperimentalFixupGetTag(hooks.getTag);
};
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "BD_CLOSURE_PROPERTY_NAME", "$get$BD_CLOSURE_PROPERTY_NAME", () => A.getIsolateAffinityTag("_$bd_bdClosure"));
  ...
  (function nativeSupport() {
    !function() {
      ...
      init.getIsolateTag = function(name) {
        return intern("___bd_" + name + init.isolateTag);
      };
      var tableProperty = "___bd_isolate_tags_";
  ...
  (function(callback) {
    ...
    if (typeof bdMainRunner === "function")
      bdMainRunner(callMain, []);
    else
      callMain([]);
  });
})();
